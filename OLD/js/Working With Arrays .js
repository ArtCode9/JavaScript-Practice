...
console.log(numDeposits2000);                  
console.log(typeof numDeposits2000);                  
                  
console.log(accounts.flatMap(acc => acc.movements).filter(mov => mov >= 1000));
console.log(typeof accounts.flatMap(acc => acc.movements).filter(mov => mov >= 1000));


// tips  about ++ operator   (Prefixed ++ operator)
let a = 10;
// console.log(++a);    <<<< this is solve this problem  
console.log(a++);
console.log(a);
...
console.log(bank4);
console.log(typeof bank4);


// Practice 4
// this is a nice title -> This Is a Nice Title
const convertTitleCase = function (title) {
      const capitzalize = str => str[0].toUpperCase() +
      str.slice(1);
